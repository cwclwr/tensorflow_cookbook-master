...
print('the value of mov averange layer is:',sess.run(mov_avg_layer, feed_dict={x_data: x_val}))

# After custom operation, size is now 2x2 (squeezed out size 1 dims)
print('the value of custom layer is:',sess.run(custom_layer1, feed_dict={x_data: x_val}))
